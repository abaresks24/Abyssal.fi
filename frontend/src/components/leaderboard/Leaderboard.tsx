...
// Realistic-looking mock leaderboard data
...
export function Leaderboard() {
  ...
  const ColHeader = ({ label, field }: { label: string; field: Sort }) => (
    ...
    >
      {label}
      {sort === field && <span style={{ fontSize: 9 }}>▼</span>}
    </span>
  );
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <h2 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-0.02em' }}>Leaderboard</h2>
        <div style={{ flex: 1 }} />
        <span style={{
      ...
      <div style={{ display: 'flex', gap: 12 }}>
        {[
          ...
          { label: 'Active Traders', value: String(MOCK_TRADERS.length) },
          ...
          <div key={t.address} style={{
            ...
            <div style={{ display: 'flex', gap: 16 }}>
              <div>
                ...
                <div style={{ fontSize: 16, fontWeight: 700, fontFamily: 'var(--mono)', color: t.pnl >= 0 ? 'var(--green)' : 'var(--red)' }}>
                  {t.pnl >= 0 ? '+' : ''}${fmt(t.pnl, 0)}
                </div>
              </div>
              <div>
                <div style={{ fontSize: 10, color: 'var(--text3)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Win Rate</div>
                <div style={{ fontSize: 16, fontWeight: 700, fontFamily: 'var(--mono)', color: 'var(--cyan)' }}>
                  {t.winRate}%
                </div>
              </div>
            </div>
      ...
      <div style={{
        ...
        <div style={{
          display: 'grid',
          gridTemplateColumns: '48px 1fr 120px 120px 80px 80px 120px',
          padding: '10px 16px',
          background: 'var(--bg)',
        ...
        {sorted.map((t, i) => (
          ...
          >
            ...
            <span className="mono" style={{ color: t.pnl >= 0 ? 'var(--green)' : 'var(--red)', fontWeight: 600 }}>
              {t.pnl >= 0 ? '+' : ''}${fmt(t.pnl, 0)}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <span className="mono" style={{ fontSize: 11, color: t.winRate >= 60 ? 'var(--green)' : 'var(--text2)', minWidth: 32, textAlign: 'right' }}>
                {t.winRate}%
              </span>
            </div>
